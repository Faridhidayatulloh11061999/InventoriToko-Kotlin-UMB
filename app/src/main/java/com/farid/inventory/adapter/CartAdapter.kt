...
import coil.load
import com.farid.inventory.R
import com.farid.inventory.model.CartItem
...
class CartAdapter(
    ...
    override fun onBindViewHolder(holder: CartViewHolder, position: Int) {
        ...
        val safeImageUrl = cartItem.product.imageUrl.ifBlank { "https://cdn.pixabay.com/photo/2017/07/09/03/19/home-2486092_1280.jpg" }
